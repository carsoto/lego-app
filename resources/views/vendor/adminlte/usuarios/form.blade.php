...
<div class="form-group col-sm-6">
	...
	{!! Form::text('name', $usuario->name, array('class' => 'form-control', 'placeholder' => 'Nombres')) !!}
...
<div class="form-group col-sm-6">
	...
	{!! Form::text('lastname', $usuario->lastname, array('class' => 'form-control', 'placeholder' => 'Apellidos')) !!}
...
<div class="form-group col-sm-6">
	...
	{!! Form::text('username', $usuario->username, array('class' => 'form-control', 'placeholder' => 'Usuario')) !!}
